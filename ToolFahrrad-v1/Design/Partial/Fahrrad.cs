...
namespace ToolFahrrad_v1.Design
{
    ...
    partial class Fahrrad
    {
        ...
        {
            tab.SelectedTab = tab_produktion;
        }
        ...
        {
            tab.SelectedTab = tab_arbeitzeit;
        }
        ...
        {
            tab.SelectedTab = tab_bestellverwaltung;
        }
        ...
        private void button_nav_6_Click(object sender, EventArgs e)
        {
            ...
            tab.SelectedTab = tab_marktplatz;
        }
        ...
        {
            tab.SelectedTab = tab_einstellungen;
        }
    }
}
