...
namespace ToolFahrrad_v1.Design
{
    public partial class Fahrrad : Form
    {
        ...
        private void button_nav_einstellungen_Click(object sender, EventArgs e)
        {

        }

        private void einstellungen_textBox1_TextChanged(object sender, EventArgs e)
        {

        }

        private void einstellungen_radioButton1_CheckedChanged_Click(object sender, EventArgs e)
        {
            ChangeLanguage("deutsch");
        ...
        private void einstellungen_radioButton2_CheckedChanged_Click(object sender, EventArgs e)
        {
            ChangeLanguage("englisch");
        ...
        private void einstellungen_button1_Click(object sender, EventArgs e)
        {
            BenutzerHandbuch();
        }

        private void einstellungen_button2_Click(object sender, EventArgs e)
        {
            VideoTutorial();
        }
